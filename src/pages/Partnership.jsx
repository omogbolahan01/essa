    ...
    <div className="partnership-area">
      <div className="partners-top">
        <div className="partners">
          <h3>Partnership Opportunities with Essa</h3>
          <p>
            Welcome to the Essa Partnership Program! At Essa, we believe in the
            power of collaboration. Partnering with us opens the door to a world
            of innovative e-commerce solutions and mutually beneficial
            opportunities.
          </p>
          <button className="partners-button">Request to join</button>
        </div>
